...
package net.mcreator.overkill.fluid.attributes;
...
public class NitrogyenFluidAttributes extends FluidAttributes {
	...
	public static CustomBuilder builder(ResourceLocation stillTexture, ResourceLocation flowingTexture) {
		return new CustomBuilder(stillTexture, flowingTexture, NitrogyenFluidAttributes::new);
	}

	protected NitrogyenFluidAttributes(Builder builder, Fluid fluid) {
		super(builder, fluid);
	}

	@Override
	public int getColor(BlockAndTintGetter world, BlockPos pos) {
		return Minecraft.getInstance().level.getBiome(pos).getFogColor() | 0xFF000000;
	}
}
