...
public class TripTrunkDecorator extends TrunkVineDecorator {
	public static final TripTrunkDecorator INSTANCE = new TripTrunkDecorator();
	public static com.mojang.serialization.Codec<TripTrunkDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("trip_tree_trunk_decorator");
